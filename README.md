About cookies-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cookies-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5187&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cookies-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cookies` can be installed with `conda`:
...
```
mamba install cookies
```

It is possible to list all of the versions of `cookies` available on your platform with `conda`:
...
```
mamba search cookies --channel conda-forge
```
...
mamba repoquery search cookies --channel conda-forge

# List packages depending on `cookies`:
mamba repoquery whoneeds cookies --channel conda-forge

# List dependencies of `cookies`:
mamba repoquery depends cookies --channel conda-forge
```
